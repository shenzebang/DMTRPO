...
class HalfCheetahVelEnv_FL(HalfCheetahEnv):
    ...
    """
    def __init__(self):
        self._goal_vel = np.random.uniform(0.5, 1.0)
...
class HalfCheetahEnv_FL(HalfCheetahEnv):
    """Half-cheetah environment with target velocity, as described in [1]. The
    code is adapted from
    https://github.com/cbfinn/maml_rl/blob/9c8e2ebd741cb0c7b8bf2d040c4caeeb8e06cc95/rllab/envs/mujoco/half_cheetah_env_rand.py
    ...
    """
    def __init__(self):
        self._coeff = np.random.uniform(0.8, 1.0)
        super(HalfCheetahEnv_FL, self).__init__()
    ...
    def step(self, action):
        ...
        reward = (reward_ctrl + reward_run) * self._coeff
        done = False
...
class HalfCheetahEnv_Bias(HalfCheetahEnv):
    ...
    def step(self, action):
        ...
        reward_ctrl = - 0.1 * np.square(action).sum()
        reward_run = (xposafter - xposbefore) / self.dt
        reward = (reward_ctrl + reward_run) + self._bias
        done = False
        return ob, reward, done, dict(reward_run=reward_run, reward_ctrl=reward_ctrl)
...
class HalfCheetahEnv_10Bias(HalfCheetahEnv):
    """Half-cheetah environment with target velocity, as described in [1]. The
    code is adapted from
    https://github.com/cbfinn/maml_rl/blob/9c8e2ebd741cb0c7b8bf2d040c4caeeb8e06cc95/rllab/envs/mujoco/half_cheetah_env_rand.py
    ...
    """
    def __init__(self):
        self._bias = np.random.uniform(-0.05, 0.05)
        super(HalfCheetahEnv_10Bias, self).__init__()
    ...
    def step(self, action):
        ...
        reward_ctrl = - 0.1 * np.square(action).sum()
        reward_run = (xposafter - xposbefore) / self.dt
        reward = (reward_ctrl + reward_run) * (1 + self._bias)
        done = False
        return ob, reward, done, dict(reward_run=reward_run, reward_ctrl=reward_ctrl)
...
class HalfCheetahEnv_20Bias(HalfCheetahEnv):
    """Half-cheetah environment with target velocity, as described in [1]. The
    code is adapted from
    https://github.com/cbfinn/maml_rl/blob/9c8e2ebd741cb0c7b8bf2d040c4caeeb8e06cc95/rllab/envs/mujoco/half_cheetah_env_rand.py
    ...
    """
    def __init__(self):
        self._bias = np.random.uniform(-0.1, 0.1)
        super(HalfCheetahEnv_20Bias, self).__init__()
...
class HalfCheetahEnv_50Bias(HalfCheetahEnv):
    """Half-cheetah environment with target velocity, as described in [1]. The
    code is adapted from
    https://github.com/cbfinn/maml_rl/blob/9c8e2ebd741cb0c7b8bf2d040c4caeeb8e06cc95/rllab/envs/mujoco/half_cheetah_env_rand.py
    ...
    """
    def __init__(self):
        self._bias = np.random.uniform(-0.25, 0.25)
        super(HalfCheetahEnv_50Bias, self).__init__()
